...
from src.errors import install_api_error_handlers, request_id_middleware
from src.observability.redaction import configure_log_redaction
from src.routes.criterion_results import router as criterion_results_router
from src.routes.match_runs import router as match_runs_router
from src.routes.patients import router as patients_router
from src.routes.system import router as system_router
from src.routes.trial_syncs import router as trial_syncs_router
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        },
        {
            "name": "match-runs",
            "description": (
                "Queued lexical and semantic trial retrieval runs over synthetic "
                "patient imports."
            ),
        },
        {
